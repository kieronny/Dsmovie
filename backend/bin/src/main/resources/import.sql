...
alter table if exists tb_score add constraint FK23yhb6qop0f6hnb72hcorm3cyv foreign key (movie_id) references tb_movie;
alter table if exists tb_score add constraint FKL8lgmbrjoavOthqqtqxévrr4k foreign key (user_id) references tb_user;:
